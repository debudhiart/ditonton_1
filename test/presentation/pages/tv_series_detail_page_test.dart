...
void main() {
  ...
  testWidgets(
    ...
    when(mockNotifier.recommendationStateTVSeries)
        .thenReturn(RequestState.Loaded);
    when(mockNotifier.tvSeriesRecommendations).thenReturn(<TVSeries>[]);
    when(mockNotifier.isAddedTVSeriesToWatchlist).thenReturn(false);
  ...
  testWidgets(
    ...
    when(mockNotifier.recommendationStateTVSeries)
        .thenReturn(RequestState.Loaded);
    when(mockNotifier.tvSeriesRecommendations).thenReturn(<TVSeries>[]);
    when(mockNotifier.isAddedTVSeriesToWatchlist).thenReturn(true);
